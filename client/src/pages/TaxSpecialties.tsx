  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white font-sans">
      ...
      <div className="max-w-5xl mx-auto py-32 px-6">
        ...
        <div className="mt-20 p-12 bg-yellow-500 rounded-3xl text-slate-950 text-center">
          <h2 className="text-3xl font-bold mb-4 italic">Ready for Institutional Readiness?</h2>
          <p className="text-lg font-medium mb-8">Schedule a deep-dive strategy session for your specific tax landscape.</p>
          <button className="bg-slate-950 text-white px-10 py-4 rounded-full font-bold hover:scale-105 transition-transform">
