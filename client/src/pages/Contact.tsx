              ...
              <form className="space-y-6 relative z-10" onSubmit={(e) => e.preventDefault()}>
                <div className="grid sm:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Input placeholder="John Doe" className="h-12 border-slate-200" />
                  </div>
                  <div className="space-y-2">
                    <label className="text-sm font-bold text-slate-900">Email Address</label>
                    <Input type="email" placeholder="john@example.com" className="h-12 border-slate-200" />
                  </div>
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-bold text-slate-900">Subject</label>
                  <Input placeholder="How can we help?" className="h-12 border-slate-200" />
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-bold text-slate-900">Message</label>
                  <Textarea placeholder="Tell us about your venture..." className="min-h-[150px] border-slate-200" />
                </div>
                <Button className="w-full bg-primary text-white font-bold h-14 text-lg hover:bg-secondary hover:text-primary transition-all shadow-xl shadow-primary/10">
